...
# %% auto 0
__all__ = ['OpenCvImage', 'get_name_', 'dpi', 'label_mask', 'find_rotation_angle', 'rotate_image', 'show_labeled_mask',
           'write_new_mask', 'remove_object_from_mask', 'read_img', 'blur_img_', 'median_img_', 'canny_img_',
           'sharpen_img_', 'bilateral_img_', 'nlm_filter_', 'tv_filter_', 'filter_img_', 'add_text_to_image',
           'denoise_img', 'show_', 'center_crop', 'overlay_mask', 'overlay_mask_border_on_image',
