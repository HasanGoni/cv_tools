...
# %% auto 0
__all__ = ['OpenCvImage', 'get_name_', 'dpi', 'show_images_', 'clean_ipython_hist', 'clean_tb', 'clean_mem', 'read_config',
           'label_mask', 'find_rotation_angle', 'rotate_image', 'show_labeled_mask', 'write_new_mask',
           'remove_object_from_mask', 'read_img', 'blur_img_', 'median_img_', 'canny_img_', 'sharpen_img_',
           'bilateral_img_', 'nlm_filter_', 'tv_filter_', 'filter_img_', 'add_text_to_image',
           'create_image_posters_with_analysis', 'denoise_img', 'show_', 'center_crop', 'overlay_mask',
           'overlay_mask_border_on_image', 'overlay_mask_border_on_image_frm_img', 'concat_images',
...
def show_images_(
    ...
    # Calculate n_rows and n_cols based on number of images
    n_images = len(images)
    n_cols = min(n_images, 3)  # Max 3 columns for better visualization
